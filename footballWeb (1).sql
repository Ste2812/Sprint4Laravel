...
INSERT INTO `migrations` VALUES (34,'2014_10_12_000000_create_users_table',1),(35,'2014_10_12_100000_create_password_resets_table',1),(36,'2014_10_12_200000_add_two_factor_columns_to_users_table',1),(37,'2019_08_19_000000_create_failed_jobs_table',1),(38,'2019_12_14_000001_create_personal_access_tokens_table',1),(39,'2022_04_15_175217_create_sessions_table',1),(40,'2022_04_15_202627_teams',1),(41,'2022_04_15_204337_create_games_table',1);
...
CREATE TABLE `teams` (
  ...
  `partidos_ganados` int DEFAULT NULL,
  `partidos_perdidos` int DEFAULT NULL,
  `partidos_empatados` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `descripción` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-04-15 23:39:27
